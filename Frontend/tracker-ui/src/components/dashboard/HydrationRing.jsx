...
export default function HydrationRing() {
  ...
  return (
    <div className="w-full h-[300px] rounded-3xl bg-[#0F172A]/50 border border-white/5 p-6 relative overflow-hidden backdrop-blur-xl group hover:-translate-y-1 hover:border-[#0EA5E9]/30 transition-all duration-300 shadow-[0_8px_30px_rgba(0,0,0,0.5)] flex flex-col items-center justify-center">
      ...
      <div className="absolute top-6 left-6 flex flex-col">
         <h3 className="text-sm font-black text-white uppercase tracking-widest">Hydration</h3>

      ...
      <div className="w-full h-[180px]">
        {data.length > 0 ? (
          ...
          <div className="flex flex-col items-center justify-center h-full gap-3 text-gray-400 border border-white/5 rounded-2xl bg-white/[0.02]">
            <Droplet className="w-8 h-8 opacity-40 text-[#0EA5E9]" />
            <div className="text-center">
              <div className="text-xs font-bold text-white mb-1">No hydration data</div>
              <div className="text-[10px] text-white/50 mb-3">Log your water intake to see<br/>hydration trends.</div>
            </div>
          </div>
        )}
      </div>

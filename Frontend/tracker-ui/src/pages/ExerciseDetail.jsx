...
import { ArrowLeft, Dumbbell, Award, HelpCircle, CheckCircle2, Play, ExternalLink } from 'lucide-react';
import api from '../api/axios';

// Convert YouTube embed URL → watch URL for fallback
          ...
          <div className="space-y-6">
            ...
            {exercise.youtube_url ? (
              <div className="space-y-3">
                <div className="relative w-full aspect-video rounded-2xl overflow-hidden border border-outline-variant/50 shadow-2xl bg-black">
                  <iframe
                    className="absolute inset-0 w-full h-full"
                    src={`${exercise.youtube_url}?rel=0&modestbranding=1`}
                ...
                {/* Fallback: open directly on YouTube if iframe is blocked */}
                <a
                  href={embedToWatchUrl(exercise.youtube_url)}
                  target="_blank"

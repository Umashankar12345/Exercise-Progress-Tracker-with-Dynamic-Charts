        ...
        <div className="w-full max-w-md animate-in slide-in-from-right duration-700">
          ...
          <form onSubmit={submit} className="space-y-5">
            ...
            <div className="grid grid-cols-2 gap-3">
              <a href={`${getBackendHost()}/auth/google`} className="flex items-center justify-center gap-2 border border-outline-variant bg-surface-container hover:bg-surface-bright text-sm font-medium text-on-surface py-3 rounded-xl transition-colors">
              ...
              <a href={`${getBackendHost()}/auth/github`} className="flex items-center justify-center gap-2 border border-outline-variant bg-surface-container hover:bg-surface-bright text-sm font-medium text-on-surface py-3 rounded-xl transition-colors">
          ...
          {/* SECURITY INDICATORS */}
          <div className="mt-8 pt-8 border-t border-outline-variant flex flex-wrap items-center justify-center gap-4">
            <div className="flex items-center gap-1.5 text-[10px] font-bold uppercase tracking-widest text-on-surface-variant">
              <LockKeyhole className="w-3.5 h-3.5 text-[#3B82F6]" />

        ...
        <div className="w-full max-w-md animate-in slide-in-from-right duration-700">
          ...
          <form onSubmit={submit} className="space-y-5">
            ...
            <div className="grid grid-cols-2 gap-3">
              <a href="http://localhost:8000/auth/google" className="flex items-center justify-center gap-2 border border-outline-variant bg-surface-container hover:bg-surface-bright text-sm font-medium text-on-surface py-3 rounded-xl transition-colors">
              ...
              <a href="http://localhost:8000/auth/github" className="flex items-center justify-center gap-2 border border-outline-variant bg-surface-container hover:bg-surface-bright text-sm font-medium text-on-surface py-3 rounded-xl transition-colors">
